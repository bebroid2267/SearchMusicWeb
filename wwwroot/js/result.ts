...
document.addEventListener('DOMContentLoaded', function () {
    $(function () {
        ...
        const gradientDiv = document.getElementById('gradient-box') as HTMLDivElement;
    ...
    const trackManager: TrackManager = new TrackManager();


    const progressBar = document.querySelector('.progress') as HTMLDivElement;
    const tracksElement = document.querySelector('.tracksQuery') as HTMLElement;
    const tracksValue = tracksElement.dataset.value;
    const progressContainer = document.querySelector('.progress__container') as HTMLDivElement;
    const nextTrackBtn = document.querySelector('.next-track-button') as HTMLButtonElement;
    const prevTrackBtn = document.querySelector('.prev-track-button') as HTMLButtonElement;
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response && response.trackList && Array.isArray(response.trackList)) {
                            ...
                            response.trackList.forEach(function (track: ITrack) {
    ...
    $('.tracks').on('click', '.track-item', function (): void {
    ...
    function updateProgressTrack(e: any): void {
