...
const MainButtons = ({onClickHome, onClickFav, onClickLogin, onClickLogout, isUserAuth}: any) => {
  return (
    <StyledWrapper>
      <div id="navbody">
        <form action="#">
          <ul className="ul">
            ...
            <label htmlFor="choose1" className='lable'>
              <li className="li" onClick={onClickHome}>
            ...
            <label htmlFor="choose3" className='lable'>
              <li className="li" onClick={onClickFav}>
            ...
            <input className="radio" name="rad" id="choose5" type="radio" />
            {!isUserAuth ? 
            <label htmlFor="choose4" className='lable'>
              <li className="li" onClick={onClickLogin}>
             ...
             <label htmlFor="choose5" className='lable'>
              <li className="li" onClick={onClickLogout}>
                <svg viewBox="0 0 20 20" fill="none" height={24} width={24} xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="svg-exit w-6 h-6 text-gray-800 dark:text-white">
                  <path d="M10 19H5a1 1 0 0 1-1-1v-1a3 3 0 0 1 3-3h2m10 1a3 3 0 0 1-3 3m3-3a3 3 0 0 0-3-3m3 3h1m-4 3a3 3 0 0 1-3-3m3 3v1m-3-4a3 3 0 0 1 3-3m-3 3h-1m4-3v-1m-2.121 1.879-.707-.707m5.656 5.656-.707-.707m-4.242 0-.707.707m5.656-5.656-.707.707M12 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" strokeWidth={2} strokeLinejoin="round" strokeLinecap="square" stroke="currentColor" />
                </svg>
              </li>
            </label>
